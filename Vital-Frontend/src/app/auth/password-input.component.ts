...
@Component({
  ...
  template: `
      <div class="flex relative">
          ...
          <button class="absolute top-1/2 -translate-y-1/2 right-5" (click)="togglePasswordVisibility()">
              <svg *ngIf="!passwordVisible" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                   viewBox="0 0 256 256">
                  <path fill="lightgray"
