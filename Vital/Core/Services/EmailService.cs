...
<p>
Hello, {user.UserName},
to verify your email click: <br/>
<a style=""padding: 5px 15px; text-decoration:none; border-radius: 5px; background-color: #d1c1d7; color: #100e11"" href=""{globalSettings.Value.FrontEndUrl}/verify-email?userId={user.Id}&token={HttpUtility.UrlEncode(token)}""> Verify email </a>  
</p> 
<p> 
